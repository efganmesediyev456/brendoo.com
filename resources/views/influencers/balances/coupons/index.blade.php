                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('coupons.index', ['influencer'=>request()->influencer]) }}" class="btn btn-primary">Geri Qayıt</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-centered mb-0 align-middle table-hover table-nowrap">
                                    ...
                                    @foreach($uses as $balance)
                                        ...
                                        <tr>
                                            ...
                                            <td scope="row">{{$balance->orderItem?->product?->title}}</td>
                                ...
                                <br>
                                {{ $uses->links('admin.vendor.pagination.bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
