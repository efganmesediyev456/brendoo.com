    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{route('abouts.update', $about->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$about->translate('en')->title}}</h4>
                        <div class="row">
                            <div class="col-6">

                                <div class="mb-3">
                                    <label class="col-form-label">Başlıq en</label>
                                    <input class="form-control" type="text" name="en_title" value="{{$about->translate('en')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ru_title" value="{{$about->translate('ru')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_en" class="form-control" type="text" name="en_description">{{$about->translate('en')->description}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_ru" class="form-control" type="text" name="ru_description">{{$about->translate('ru')->description}}</textarea>
