                        ...
                        <div class="col-12">
                            <nav aria-label="breadcrumb" style="margin-bottom: 20px;">
                                <ol class="breadcrumb bg-light p-3 rounded">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('tiktoks.index') }}">Siyahı</a>
                                    </li>
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ $tiktok->translate('en')?->title }}</li>
                                </ol>
                            </nav>
                            <form method="GET" action="{{ route('tiktoks.show', $tiktok->id) }}">
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <a href="{{ route('tiktoks.show', $tiktok->id) }}" class="btn btn-secondary">Sıfırla</a>
                            </form>
                            <br>
                                ...
                                <table class="table table-centered mb-0 align-middle table-hover table-nowrap">
                                    ...
                                    @foreach($products as $key => $product)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('assign_tiktok', [$tiktok->id, $product->id]) }}"
                        ...
                        <div class="col-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered mb-0 align-middle table-hover table-nowrap">
                                    ...
                                    <tbody>
                                    @foreach($tiktok->products as $key => $product)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$product->is_active  ? 'Active' : 'Deactive'}}</td>
                                            <td>
                                                <form action="{{ route('remove_assign_tiktok', [$tiktok->id, $product->id]) }}"
