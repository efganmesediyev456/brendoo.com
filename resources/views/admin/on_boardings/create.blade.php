    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <form action="{{route('on_boardings.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="en_sub_title">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="ru_sub_title">
