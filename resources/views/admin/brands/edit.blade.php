                    ...
                    <div class="card-body">
                        <nav aria-label="breadcrumb" style="margin-bottom: 20px;">
                            <ol class="breadcrumb bg-light p-3 rounded">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('brands.index') }}">Siyahı</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{ $brand->translate('en')?->title }}</li>
                            </ol>
                        </nav>
                            ...
                            @foreach([ 'en', 'ru'] as $lang)
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang }}" role="tabpanel" aria-labelledby="{{ $lang }}-tab">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="{{ $lang }}_title" value="{{ $brand->translate($lang)?->title }}">
