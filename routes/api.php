...
//        Route::get('/settlements/{districtId}', [LocationController::class, 'getSettlements']);
    ...
    Route::get('/category/{id}/get-filters', [CategoryController::class, 'get_filters']);
    ...
    Route::get('home_categories', [CategoryController::class, 'home_categories_last']);
    // Route::get('home_categories_last', [CategoryController::class, 'home_categories_last']);
...
Route::group(['prefix' => 'influencers', 'as' => 'influencers.'], function () {
    ...
    Route::post('/password-reset/request', [InfluencerAuthController::class, 'requestPasswordReset']);
    Route::post('/password-reset/reset', [InfluencerAuthController::class, 'resetPassword']);
    ...
    Route::middleware(['auth:influencers'])->group(function () {
